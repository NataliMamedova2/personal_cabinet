...
return $this->privates['security.user.provider.concrete.in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(array('front_user' => array('password' => 'frontend_password', 'roles' => array(0 => 'ROLE_FO_CUSTOMER'))));
