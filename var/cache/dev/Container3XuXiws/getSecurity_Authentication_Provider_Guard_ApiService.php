...
}, 1), ($this->privates['security.user.provider.concrete.in_memory'] ?? $this->load('getSecurity_User_Provider_Concrete_InMemoryService.php')), 'api', ($this->privates['security.user_checker'] ?? $this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker()));
