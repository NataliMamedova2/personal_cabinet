...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            'App\\Controller\\BO\\CategoryController' => 'getCategoryControllerService.php',
            'App\\Controller\\BO\\CustomersController' => 'getCustomersControllerService.php',
            'App\\Controller\\BO\\DashboardController' => 'getDashboardControllerService.php',
            'App\\Controller\\BO\\OrdersController' => 'getOrdersControllerService.php',
            'App\\Controller\\BO\\PagesController' => 'getPagesControllerService.php',
            'App\\Controller\\BO\\ProductsController' => 'getProductsControllerService.php',
            'App\\Controller\\BO\\SettingsController' => 'getSettingsControllerService.php',
            'App\\Controller\\BO\\UsersController' => 'getUsersControllerService.php',
            'App\\Controller\\FO\\ApiController' => 'getApiControllerService.php',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('iHnNa+ewe3', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KuxJ+U9Qp3', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sp-zAaai+z', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ESsW2i9CBu', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TOSAls6Qsn', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uriI5wxx-Q', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(array('security.firewall.map.context.api' => function () {
            ...
            yield 'security.firewall.map.context.login' => ($this->privates['.security.request_matcher.yG2fF4M'] ?? $this->privates['.security.request_matcher.yG2fF4M'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/login'));
            yield 'security.firewall.map.context.api' => ($this->privates['.security.request_matcher.8LS3yve'] ?? $this->privates['.security.request_matcher.8LS3yve'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/secure'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'lexik_jwt_authentication.pass_phrase' => 'FRONT',
