...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\AppUserType' => function () {
    return ($this->privates['App\Form\AppUserType'] ?? $this->privates['App\Form\AppUserType'] = new \App\Form\AppUserType());
