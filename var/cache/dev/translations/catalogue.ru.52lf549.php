...
$catalogueEn = new MessageCatalogue('en', array (
  ...
  array (
    ...
    'menu.toggle_nav' => 'Language',
    'users.table.title' => 'Users',
    'users.first.name' => 'First name',
    'users.last.name' => 'Last name',
    'users.actions' => 'Actions',
    'users.no.record.found' => 'no records found',
    'users.add' => 'Add new user',
    'users.password' => 'Password',
    'users.password.repeat' => 'Confirm password',
    'users.login' => 'Login',
    'users.delete' => 'Delete',
    'users.show' => 'Show',
    'users.edit' => 'Edit',
